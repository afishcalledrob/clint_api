Event.create([
  ...
  {title: "Hot Tug", description: "The Dutch have given us many great things ans the The Hot Tug is no exception.  Travel down the Thames with your friends in a hot tub and enjoy the views as you sit HotTug is a 3.8m x 2m wood fired floating hot tub, heated at an invigorating 38C of fresh water which ‘HotTuggers’ can operate by themselves. The boat is powered by an electric engine and is stationed in Old Street at the ‘HotTug House’. The experience, which lasts for 90 minutes is truly unique and is one of the most fun and unusual activities in London.",url: "https://www.hottuguk.com",location: "London",price_range: 4,category: "Quirky", images: "https://s3.eu-west-2.amazonaws.com/makemydayimages/hot_tug_river.jpg"},
  {title: "Science Museum - late night",description: "Science Museum Lates are adults-only, after-hours theme nights that take place in the museum on the last Wednesday of every month.  Join us in a celebration of all things medical, from the 70th anniversary of the NHS to the 50th anniversary of the first liver and heart transplants. Learn about how 3D printing is revolutionising the world of transplantation, get hands-on with the Royal College of Pathologists and test your knowledge in our NHS quiz!",url: "https://www.sciencemuseum.org.uk/see-and-do/lates?gclid=CjwKCAjw9-HZBRAwEiwAGw0QcavL3QiolyTp5IWafrWo1FsvkiDEANNzb_FlUcyGTBTAyu6aJzxxVxoCHssQAvD_BwE", location: "London", price_range: 1, category: "Quirky", images: "https://makersstudents.slack.com/archives/DARNNEVH8/p1530537990000376"},
  {title: "Boat Cinema", description: "Can you imagine watching a movie under the stars on the top deck of a boat on thr river Thames? Time Out will make that dream a reality this summer with Time Out Live presents Movies on the River with City Cruises – London’s first ever cinema on the Thames. Each night throughout June and July a movie boat will offer a food and drink-fuelled sunset cruise from the Tower of London.", url: "https://makersstudents.slack.com/archives/DARNNEVH8/p1530538083000394", location: "London", price_range: 2, category: "Quriky", images: "https://s3.eu-west-2.amazonaws.com/makemydayimages/boat_cinema.jpg"},
  {title: "B.Y.O.C", description: "At BYOC we strive to deliver everything that was great about the Speakeasy without the danger of being busted by the coppers at any moment! Simply bring a bottle of your favourite spirit to one of our hidden-away haunts and have our team of skilled bartenders, armed with an exciting array of homemade syrups, juices, and bitters, fix you something that really tickles your fancy. Whether your taste buds are lusting after a classic or something a little more adventurous, your palate will be sated.", url: "https://www.byoc.co.uk/", location: "London", price_range: 2, category: "Quirky", images: "https://s3.eu-west-2.amazonaws.com/makemydayimages/BYOC.jpg"},
  {title: "Urban Axe Throwing", description: "You'll be slinging axes side by side against your friends, hitting bullseys and cheering on your mates.  All backed up with great music and atmosphere and a chance to socialise between throws.", url: "https://whistlepunks.com/", location: "London", price_range: 3, category: "Active", images: "https://s3.eu-west-2.amazonaws.com/makemydayimages/axe-throwing.jpg"},
  {title: "Tiroler Hut", description: "Joseph your host welcomes you to a lively evening of entertainment including Yodelling, Accordion and the highly original Tirolean Cow Bell Show, as featured on television. Staff in traditional Austrian Dress, as they are every night!", url: "http://www.tirolerhut.co.uk/", location: "London", price_range: 3, category: "Quirky", images: "https://s3.eu-west-2.amazonaws.com/makemydayimages/Tiroler_hut.jpg"},
  {title: "The Mystery of Gilmerton Cove", description: "Glimterton Cover is a series of hand carved passways and chambers that lie below ground to the south of Gilmerton Crosswroads.  The entrance to Gilmberton Cove is through a vistor centre adapted from a traditional mining cottage.  This cottage now houses imaginative audio and visual displays that dipict various theories behind the origins of Gilmerton Cove which, after extensive archeological and historical research, still remain a mystery.", url: "www.gilmertoncover.org.uk", location: "Edinburgh", price_range: 1, category: "Culture", images: "https://s3.eu-west-2.amazonaws.com/makemydayimages/gilmerton_cove.jpg"},
  {title: "The Sheep Heid Inn", description: "The oldest pub in the UK.  The perfect destination for lunch, dinner, or drinks, this contemporary pub, bar, and restaurant will allow you to dine in style, no matter what the occasion.", url: "www.thesheephiededinurgh.co.uk", location: "Edinburgh", price_range: 3, category: "Chill", images: "https://s3.eu-west-2.amazonaws.com/makemydayimages/sheep_heid_inn.jpg"},
  {title: "Portobello Beach", description: "Portobello Beach, a few miles from Edinburgh city centre, is a charming seaside subberb, with two miles of sand making it perfect for swimming and sunbathing", url: "https://www.visitscotland.com/info/towns-villages/portobello-beach-p730811", location: "Edinburgh", price_range: 1, category: "Chill", images: "https://s3.eu-west-2.amazonaws.com/makemydayimages/Portobello-Beach-in-Edinburgh-4.jpg"},
  {title: "Ghost and Tourture Tour", description: "Take a step back into the Scottish capital’s grisly past on this 1-hour ghost and torture tour in Edinburgh. Follow a guide through Edinburgh’s historic Old Town and hear tales of crime, witchcraft and deceit! Learn of the poor souls left to rot in jail and hear of the plight of the city’s many plague victims. On this gruesome and grimy tour, gain insight into the Edinburgh of a bygone era and see the city in a whole new light. Afterward, enjoy free entry into the torture museum.", url: "https://uk.viator.com/tours/Edinburgh/Ghost-and-Torture-Tour-in-Edinburgh/d739-8752P2", location: "Edinburgh", price_range: 2, category: "Culture", images: "https://s3.eu-west-2.amazonaws.com/makemydayimages/edinburgh-ghost-bus-tour-02101215.jpg"}
  ])
...
AvailabilitiesEvent.create([
  ...
  {event_id:30, availability_id: 1},
  {event_id:30, availability_id: 2},
  {event_id:30, availability_id: 3},
  {event_id:30, availability_id: 4},
  {event_id:30, availability_id: 5},
  {event_id:30, availability_id: 6},
  {event_id:30, availability_id: 7},
  {event_id:30, availability_id: 8},
  {event_id:30, availability_id: 9},
  {event_id:30, availability_id: 10},
  {event_id:30, availability_id: 11},
  {event_id:30, availability_id: 12},
  {event_id:30, availability_id: 13},
  {event_id:30, availability_id: 14},
  {event_id:30, availability_id: 15},
  {event_id:30, availability_id: 16},
  {event_id:30, availability_id: 17},
  {event_id:30, availability_id: 18},
  {event_id:30, availability_id: 19},
  {event_id:30, availability_id: 20},
  {event_id:30, availability_id: 21},
  {event_id:30, availability_id: 22},
  {event_id:30, availability_id: 23},
  {event_id:30, availability_id: 24},
  {event_id:30, availability_id: 25},
  {event_id:30, availability_id: 26},
  {event_id:30, availability_id: 27},
  {event_id:30, availability_id: 28},
  {event_id:30, availability_id: 29},
  {event_id:30, availability_id: 30},
  {event_id:30, availability_id: 31},
  {event_id:31, availability_id: 25},
  {event_id:32, availability_id: 3},
  {event_id:32, availability_id: 4},
  {event_id:32, availability_id: 5},
  {event_id:32, availability_id: 6},
  {event_id:32, availability_id: 7},
  {event_id:32, availability_id: 10},
  {event_id:32, availability_id: 11},
  {event_id:32, availability_id: 12},
  {event_id:32, availability_id: 13},
  {event_id:32, availability_id: 14},
  {event_id:32, availability_id: 17},
  {event_id:32, availability_id: 18},
  {event_id:32, availability_id: 19},
  {event_id:32, availability_id: 20},
  {event_id:32, availability_id: 21},
  {event_id:32, availability_id: 24},
  {event_id:32, availability_id: 25},
  {event_id:32, availability_id: 26},
  {event_id:32, availability_id: 27},
  {event_id:32, availability_id: 28},
  {event_id:32, availability_id: 31},
  {event_id:33, availability_id: 5},
  {event_id:33, availability_id: 6},
  {event_id:33, availability_id: 7},
  {event_id:33, availability_id: 12},
  {event_id:33, availability_id: 13},
  {event_id:33, availability_id: 14},
  {event_id:33, availability_id: 19},
  {event_id:33, availability_id: 20},
  {event_id:33, availability_id: 21},
  {event_id:33, availability_id: 26},
  {event_id:33, availability_id: 27},
  {event_id:33, availability_id: 28},
  {event_id:33, availability_id: 31},
  {event_id:34, availability_id: 1},
  {event_id:34, availability_id: 2},
  {event_id:34, availability_id: 3},
  {event_id:34, availability_id: 4},
  {event_id:34, availability_id: 5},
  {event_id:34, availability_id: 6},
  {event_id:34, availability_id: 7},
  {event_id:34, availability_id: 8},
  {event_id:34, availability_id: 9},
  {event_id:34, availability_id: 10},
  {event_id:34, availability_id: 11},
  {event_id:34, availability_id: 12},
  {event_id:34, availability_id: 13},
  {event_id:34, availability_id: 14},
  {event_id:34, availability_id: 15},
  {event_id:34, availability_id: 16},
  {event_id:34, availability_id: 17},
  {event_id:34, availability_id: 18},
  {event_id:34, availability_id: 19},
  {event_id:34, availability_id: 20},
  {event_id:34, availability_id: 21},
  {event_id:34, availability_id: 22},
  {event_id:34, availability_id: 23},
  {event_id:34, availability_id: 24},
  {event_id:34, availability_id: 25},
  {event_id:34, availability_id: 26},
  {event_id:34, availability_id: 27},
  {event_id:34, availability_id: 28},
  {event_id:34, availability_id: 29},
  {event_id:34, availability_id: 30},
  {event_id:34, availability_id: 31},
  {event_id:35, availability_id: 1},
  {event_id:35, availability_id: 2},
  {event_id:35, availability_id: 3},
  {event_id:35, availability_id: 4},
  {event_id:35, availability_id: 5},
  {event_id:35, availability_id: 6},
  {event_id:35, availability_id: 7},
  {event_id:35, availability_id: 8},
  {event_id:35, availability_id: 9},
  {event_id:35, availability_id: 10},
  {event_id:35, availability_id: 11},
  {event_id:35, availability_id: 12},
  {event_id:35, availability_id: 13},
  {event_id:35, availability_id: 14},
  {event_id:35, availability_id: 15},
  {event_id:35, availability_id: 16},
  {event_id:35, availability_id: 17},
  {event_id:35, availability_id: 18},
  {event_id:35, availability_id: 19},
  {event_id:35, availability_id: 20},
  {event_id:35, availability_id: 21},
  {event_id:35, availability_id: 22},
  {event_id:35, availability_id: 23},
  {event_id:35, availability_id: 24},
  {event_id:35, availability_id: 25},
  {event_id:35, availability_id: 26},
  {event_id:35, availability_id: 27},
  {event_id:35, availability_id: 28},
  {event_id:35, availability_id: 29},
  {event_id:35, availability_id: 30},
  {event_id:35, availability_id: 31},
  {event_id:36, availability_id: 2},
  {event_id:36, availability_id: 3},
  {event_id:36, availability_id: 4},
  {event_id:36, availability_id: 5},
  {event_id:36, availability_id: 6},
  {event_id:36, availability_id: 9},
  {event_id:36, availability_id: 10},
  {event_id:36, availability_id: 11},
  {event_id:36, availability_id: 12},
  {event_id:36, availability_id: 13},
  {event_id:36, availability_id: 16},
  {event_id:36, availability_id: 17},
  {event_id:36, availability_id: 18},
  {event_id:36, availability_id: 19},
  {event_id:36, availability_id: 20},
  {event_id:36, availability_id: 23},
  {event_id:36, availability_id: 24},
  {event_id:36, availability_id: 25},
  {event_id:36, availability_id: 26},
  {event_id:36, availability_id: 27},
  {event_id:36, availability_id: 30},
  {event_id:36, availability_id: 31},
  {event_id:37, availability_id: 1},
  {event_id:37, availability_id: 2},
  {event_id:37, availability_id: 3},
  {event_id:37, availability_id: 4},
  {event_id:37, availability_id: 5},
  {event_id:37, availability_id: 6},
  {event_id:37, availability_id: 7},
  {event_id:37, availability_id: 8},
  {event_id:37, availability_id: 9},
  {event_id:37, availability_id: 10},
  {event_id:37, availability_id: 11},
  {event_id:37, availability_id: 12},
  {event_id:37, availability_id: 13},
  {event_id:37, availability_id: 14},
  {event_id:37, availability_id: 15},
  {event_id:37, availability_id: 16},
  {event_id:37, availability_id: 17},
  {event_id:37, availability_id: 18},
  {event_id:37, availability_id: 19},
  {event_id:37, availability_id: 20},
  {event_id:37, availability_id: 21},
  {event_id:37, availability_id: 22},
  {event_id:37, availability_id: 23},
  {event_id:37, availability_id: 24},
  {event_id:37, availability_id: 25},
  {event_id:37, availability_id: 26},
  {event_id:37, availability_id: 27},
  {event_id:37, availability_id: 28},
  {event_id:37, availability_id: 29},
  {event_id:37, availability_id: 30},
  {event_id:37, availability_id: 31},
  {event_id:38, availability_id: 1},
  {event_id:38, availability_id: 2},
  {event_id:38, availability_id: 3},
  {event_id:38, availability_id: 4},
  {event_id:38, availability_id: 5},
  {event_id:38, availability_id: 6},
  {event_id:38, availability_id: 7},
  {event_id:38, availability_id: 8},
  {event_id:38, availability_id: 9},
  {event_id:38, availability_id: 10},
  {event_id:38, availability_id: 11},
  {event_id:38, availability_id: 12},
  {event_id:38, availability_id: 13},
  {event_id:38, availability_id: 14},
  {event_id:38, availability_id: 15},
  {event_id:38, availability_id: 16},
  {event_id:38, availability_id: 17},
  {event_id:38, availability_id: 18},
  {event_id:38, availability_id: 19},
  {event_id:38, availability_id: 20},
  {event_id:38, availability_id: 21},
  {event_id:38, availability_id: 22},
  {event_id:38, availability_id: 23},
  {event_id:38, availability_id: 24},
  {event_id:38, availability_id: 25},
  {event_id:38, availability_id: 26},
  {event_id:38, availability_id: 27},
  {event_id:38, availability_id: 28},
  {event_id:38, availability_id: 29},
  {event_id:38, availability_id: 30},
  {event_id:38, availability_id: 31},
  {event_id:39, availability_id: 1},
  {event_id:39, availability_id: 2},
  {event_id:39, availability_id: 3},
  {event_id:39, availability_id: 4},
  {event_id:39, availability_id: 5},
  {event_id:39, availability_id: 6},
  {event_id:39, availability_id: 7},
  {event_id:39, availability_id: 8},
  {event_id:39, availability_id: 9},
  {event_id:39, availability_id: 10},
  {event_id:39, availability_id: 11},
  {event_id:39, availability_id: 12},
  {event_id:39, availability_id: 13},
  {event_id:39, availability_id: 14},
  {event_id:39, availability_id: 15},
  {event_id:39, availability_id: 16},
  {event_id:39, availability_id: 17},
  {event_id:39, availability_id: 18},
  {event_id:39, availability_id: 19},
  {event_id:39, availability_id: 20},
  {event_id:39, availability_id: 21},
  {event_id:39, availability_id: 22},
  {event_id:39, availability_id: 23},
  {event_id:39, availability_id: 24},
  {event_id:39, availability_id: 25},
  {event_id:39, availability_id: 26},
  {event_id:39, availability_id: 27},
  {event_id:39, availability_id: 28},
  {event_id:39, availability_id: 29},
  {event_id:39, availability_id: 30},
  {event_id:39, availability_id: 31},
])
